...
\input{main/filtres/mode/intuition}
\input{main/filtres/mode/hypo}
\input{main/filtres/mode/reso}
\input{main/filtres/mode/gain-depha}
\input{main/filtres/mode/interpre}
