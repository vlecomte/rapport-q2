...
\begin{table}
\begin{tabular}{|p{2cm}|p{1.5cm}|p{11.cm}|}
 ...
 \hline 
	...
	\multicolumn{3}{|l|}{}\\
 		...
 		\multicolumn{3}{|p{14.5cm}|}{\large{\textbf{Contexte :} Dans le cadre du cours de projet, il nous a été demandé de modéliser, construire, faire fonctionner et effectuer des tests sur un haut-parleur pouvant être relié à un smartphone. }}\\
	\multicolumn{3}{|l|}{}\\
 \hline
