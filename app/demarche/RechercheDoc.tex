...
\end{center}
\caption{Extrait du brevet : \og Compound loudspeaker diaphragm.\fg  \cite{f1964compound}} %REF bib
\label{Trace 1}
\end{figure}
...
\end{center}
\caption{Extrait de \og Modal Analysis of Loudspeaker Diaphragms\fg, p. 2. \cite{Miller}} %REF bib
\label{Trace 2}
\end{figure}
...
\end{center}
\caption{Extrait du brevet : \og Loudspeaker system having a bass-reflex port.\fg \cite{US6275597}} %REF bib
 \label{Trace 3}
\end{figure}
...
\end{center}
\caption{Extrait de \og La Grande Encyclopédie Larousse [en ligne]\fg, p. 6486.  \cite{Larousse}} %REF bib
\label{Trace 4}
\end{figure}
...
\end{center}
\caption{Extrait du livre \og Electronic circuit design : from concepts to implementation\fg, p. 249-251. \cite{Kularatna}} %REF bib
\label{Trace 5}
\end{figure}
...
\end{center}
\caption{Extrait de \og Engineering circuit analysis\fg, p. 375.  \cite{Irwin}}%REF bib 
\label{Trace 6}
\end{figure}
...
\end{center}
\caption{Extrait de \og Engineering circuit analysis\fg, p. 376.  \cite{Irwin}}%REF bib 
\label{Trace 7}
\end{figure}
